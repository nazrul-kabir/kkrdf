                            ...
                            <div class="box box-primary">
                                <div class="k-grid  k-secondary" data-role="grid">
                                    <div class="k-toolbar k-grid-toolbar">
                                        <a class="k-button k-button-icontext k-grid-add" href="<?php echo baseUrl('admin/view/banner/add_banner.php'); ?>">
                                ...
                                <script id="customtemplate" type="text/x-kendo-template">
                                    <a class="k-button k-button-icontext k-grid-edit" href="<?php echo baseUrl('admin/view/banner/edit_banner.php'); ?>?id=#= banner_id#"><span class="k-icon k-edit"></span>Edit</a>
                                    ...
                                    function deleteFunction(banner_id) {
                                        ...
                                        if (c === true) {
                                            $.ajax({
                                                type: "POST",
                                                dataType: "json",
                                                url: baseUrl + "admin/controller/banner/banner_list.php",
