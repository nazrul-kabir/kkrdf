            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-8">
                        <h1 class="section-title wow fadeInUp animated" style="visibility: visible;">SUJI</h1>
                        <div class="the-company wow fadeIn">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <div class="project-images">
                                    <a href="#">
                                        <img class="img-responsive" src="upload/suji.jpg" alt="SUJI">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3"></div>
                            <div class="col-md-12">
                                <div class="the-company wow fadeIn">
                                    <h2>সুজি (৫০০ গ্রাম)</h2>
                                    <p><i class="fa fa-hand-o-right"></i>&nbsp;বাছাইকৃত উন্নত গম থেকে প্রস্তুত</p>
                                    <p><i class="fa fa-hand-o-right"></i>&nbsp;অত্যাধুনিক স্বয়ংক্রিয় মেশিনে প্রক্রিয়াজাত</p>
